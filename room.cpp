...
Room::Room(QObject *parent, QGraphicsScene *scene, std::list<Proyectile *> *p, std::string name_) : QObject(parent), scene(scene), v_limit(720), h_limit(1280) {
    ...
    if(name_ == "f1-safe"){
        ...
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right_jump", p, 1000, 2000, 30, 30, 1, 950, 20, 30, 30, 2, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "double", "left_right", p, 1500, 1000, 9, 20, 1, 500, 420, 30, 30, 4, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "double", "left_right", p, 1500, 1000, 9, 20, 1, 950, 320, 30, 30, 4, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "double", "left_right", p, 1500, 1000, 9, 20, 1, 900, 570, 30, 30, 4, ":/Assets/Sprites/entities/slime.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right_jump", p, 1000, 1000, 25, 30, 1, 950, 80, 30, 30, 4, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right", p, 1500, 1000, 4, 20, 1, 330, 560, 30, 30, 4, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 1000, 1500, 9, 35, 1, 250, 20, 30, 30, 1, ":/Assets/Sprites/entities/slime.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 1000, 3500, 9, 60, 1, 140, 170, 30, 30, 0.5, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 1000, 3500, 9, 60, 1, 1280-140, 170, 30, 30, 0.5, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "x", "jump", p, 1500, 1000, 9, 45, 1, 1280/2, 140, 30, 30, 4, ":/Assets/Sprites/entities/slime.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "double", "jump", p, 500, 2500, 9, 60, 1, 1280-250, 220, 30, 30, 0.5, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "double", "jump", p, 1000, 3000, 9, 70, 1, 1280-350, 120, 30, 30, 0.5, ":/Assets/Sprites/entities/slime.png"));
        enemies.push_back(new Enemy(this, this->scene, "double", "jump", p, 1500, 4000, 9, 80, 1, 1280-450, 20, 30, 30, 0.5, ":/Assets/Sprites/entities/slime.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right_jump", p, 1000, 2000, 30, 30, 2, 850, 20, 30, 60, 0.5, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "orbit", "jump", p, 500, 2500, 9, 60, 2, 400, 320, 30, 60, 0.5, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "orbit", "jump", p, 500, 2500, 9, 60, 2, 1280-400, 320, 30, 60, 0.5, ":/Assets/Sprites/entities/priest.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "orbit", "jump", p, 1000, 2000, 9, 100, 2, 1280/2 + 25, 110, 30, 60, 1, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "orbit", "jump", p, 1000, 2000, 9, 100, 2, 425, 110, 30, 60, 1, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "orbit", "jump", p, 1000, 2000, 9, 100, 2, 1280-405, 110, 30, 60, 1, ":/Assets/Sprites/entities/priest.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right_jump", p, 1000, 2000, 30, 30, 2, 950, 20, 30, 60, 2, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 2100, 2000, 9, 60, 2, 450+75, 410, 30, 60, 1, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 2100, 2000, 9, 60, 2, 1280-600 + 75, 410, 30, 60, 1, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "orbit", "left_right", p, 1000, 400, 9, 20, 2, 430, 260, 30, 60, 2, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "orbit", "left_right", p, 1000, 400, 9, 20, 2, 1280-320, 260, 30, 60, 2, ":/Assets/Sprites/entities/priest.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right_jump", p, 1500, 2000, 30, 30, 2, 800, 20, 30, 60, 2, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 2100, 2500, 9, 60, 2, 1200, 160, 30, 60, 0.5, ":/Assets/Sprites/entities/priest.png"));
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right", p, 1000, 1000, 10, 30, 2, 1280-700, 590, 30, 60, 2, ":/Assets/Sprites/entities/priest.png"));
        ...
        walls.push_back(new Wall(this, 1280-450, 720-220, 20, 20));

        walls.push_back(new Wall(this, 350, 720-200, 100, 20));
        walls.push_back(new Wall(this, 450-20, 720-220, 20, 20));
        ...
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 1500, 2000, 9, 70, 3, 130, 320, 30, 30, 1, ":/Assets/Sprites/entities/skull.png"));
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right", p, 1500, 1000, 30, 20, 3, 300, 20, 30, 30, 4, ":/Assets/Sprites/entities/skull.png"));
        enemies.push_back(new Enemy(this, this->scene, "orbit", "left_right", p, 1500, 800, 10, 20, 3, 780, 400, 30, 30, 4, ":/Assets/Sprites/entities/skull.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right_jump", p, 1500, 2000, 30, 30, 3, 700, 20, 30, 30, 2, ":/Assets/Sprites/entities/skull.png"));
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 1500, 2000, 9, 70, 3, 825, 470, 30, 30, 1, ":/Assets/Sprites/entities/skull.png"));
        ...
        enemies.push_back(new Enemy(this, this->scene, "cross", "left_right_jump", p, 1000, 2000, 30, 30, 3, 150-10, 320, 30, 30, 2, ":/Assets/Sprites/entities/skull.png"));
        enemies.push_back(new Enemy(this, this->scene, "single", "jump", p, 1500, 1000, 30, 10, 3, 1065, 650+20, 30, 30, 2, ":/Assets/Sprites/entities/skull.png"));
        enemies.push_back(new Enemy(this, this->scene, "x", "left_right_jump", p, 1000, 2000, 30, 20, 3, 750, 20, 30, 30, 0.5, ":/Assets/Sprites/entities/skull.png"));

        bg = new QPixmap(":/Assets/Sprites/f3-3.png");
        setPos(0,0);

        spring = new Spring(nullptr, 1280-80, 5, 100, 40, 0.025f, 0.25f);
        ...
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 1500, 2000, 9, 70, 3, 1280-700, 320, 30, 30, 0.5, ":/Assets/Sprites/entities/skull.png"));
        enemies.push_back(new Enemy(this, this->scene, "cross", "jump", p, 1500, 2500, 9, 90, 3, 1280-400, 120, 30, 30, 0.5, ":/Assets/Sprites/entities/skull.png"));
